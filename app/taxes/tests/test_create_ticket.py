...
class TestDocumentCreateTicketView:
    ...
    @patch('taxes.views.requests.post')
    @patch('taxes.views.get_correlative')
    def test_create_ticket_success_without_order_id(self, mock_get_correlative, mock_post, authenticated_api_client):
        """Test successful ticket creation without order_id"""
        mock_get_correlative.return_value = '00000001'
    ...
    @patch('taxes.views.requests.post')
    @patch('taxes.views.get_correlative')
    def test_create_ticket_success_with_order_id(self, mock_get_correlative, mock_post, authenticated_api_client):
        """Test successful ticket creation with order_id"""
    ...
    @patch('taxes.views.requests.post')
    @patch('taxes.views.get_correlative')
    def test_create_ticket_order_not_found(self, mock_get_correlative, mock_post, authenticated_api_client):
    ...
    @patch('taxes.views.requests.post')
    @patch('taxes.views.get_correlative')
    def test_create_ticket_multiple_items(self, mock_get_correlative, mock_post, authenticated_api_client):
    ...
    @patch('taxes.views.requests.post')
    @patch('taxes.views.get_correlative')
    def test_create_ticket_verifies_sunat_api_call(self, mock_get_correlative, mock_post, authenticated_api_client):
    ...
    @patch('taxes.views.requests.post')
    @patch('taxes.views.get_correlative')
    def test_create_ticket_uses_ticket_type(self, mock_get_correlative, mock_post, authenticated_api_client):
