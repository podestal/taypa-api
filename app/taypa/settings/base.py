...
SECRET_KEY = 'django-insecure-8*gbclmj^wrq8=h@abmw^rs3nv6!gk3e$oqo8ag5jmh8@umr5f'
...
ASGI_APPLICATION = 'taypa.asgi.application'
...
CLOUDFLARE_R2_MAIN_URL = os.environ.get('CLOUDFLARE_R2_MAIN_URL')  # Public URL like https://pub-xxx.r2.dev

# AWS S3-compatible settings for R2 (used by django-storages)
if CLOUDFLARE_R2_ACCESS_KEY and CLOUDFLARE_R2_SECRET_KEY:
